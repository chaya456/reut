    ...
    <div className="fixed inset-0 z-[2000] flex items-center justify-center px-4">
      ...
      <div className="relative bg-[#fffcf9]/60 backdrop-blur-2xl max-w-sm w-full shadow-[0_40px_120px_rgba(183,110,79,0.2)] animate-[premiumEntry_0.8s_cubic-bezier(0.16,1,0.3,1)] border border-brand-dark/10 overflow-hidden">
        ...
        <div className="p-8 text-center relative z-10">
            ...
            <h2 className="text-3xl font-black text-brand-dark mb-1 tracking-tighter" dir="rtl">
                הנחה מיוחדת<br/>
                בסך 20%
            </h2>
            ...
            <p className="text-base text-dark-coal/80 mb-6 leading-relaxed font-semibold px-4" dir="rtl">
                על חריטות מפנקות ללמודי התורה שלנו
            </p>
            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="text-[10px] text-dark-coal/60 font-medium" dir="rtl">
                    לזמן קצר במיוחד- עד לשלושת ימי ההגבלה תשפ"ו
                </div>
            </div>
        </div>
